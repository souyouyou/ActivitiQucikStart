...
public class ActUtils {
	...
	public static void getFlowImgByInstanceId(String processInstanceId,RepositoryService repositoryService, ManagementService managementService, RuntimeService runtimeService, ProcessEngineConfiguration processEngineConfiguration, ProcessEngineFactoryBean processEngine, HistoryService historyService, TaskService taskService, String s, ServletOutputStream outputStream) {
		try {
//			 processInstanceId = "22521";
			...
			// 获取历史流程实例
			HistoricProcessInstance historicProcessInstance = historyService.createHistoricProcessInstanceQuery().processInstanceId(list.get(0).getProcessInstanceId()).singleResult();
